...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `39.6µs` | `50.4µs` |
| [Day 2](./src/bin/02.rs) | `3.7ms` | `17.6ms` |
| [Day 3](./src/bin/03.rs) | `17.1µs` | `42.2µs` |
| [Day 4](./src/bin/04.rs) | `83.6µs` | `2.4ms` |
| [Day 5](./src/bin/05.rs) | `76.9µs` | `93.4µs` |
| [Day 6](./src/bin/06.rs) | `31.9µs` | `18.2µs` |
| [Day 7](./src/bin/07.rs) | `19.6µs` | `19.9µs` |
| [Day 8](./src/bin/08.rs) | `22.3ms` | `28.9ms` |
| [Day 9](./src/bin/09.rs) | `35.5µs` | `75.1ms` |
| [Day 11](./src/bin/11.rs) | `53.9µs` | `156.0µs` |
| [Day 12](./src/bin/12.rs) | `72.3µs` | `-` |
